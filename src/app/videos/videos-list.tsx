...
import { Video as VideoData } from "@/lib/videos";
...
export default function VideosList({ videos }: { videos: VideoData[] }) {
...
function Video({
  ...
  const youtubeId = video.url.split("?")[0];
  const previewSrc = previewMissing
    ? `https://i.ytimg.com/vi/${youtubeId}/hqdefault.jpg`
    : `/videos/${video.id}-${preview}.gif`;
